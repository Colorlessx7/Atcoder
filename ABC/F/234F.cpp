...
//dp解
//漸化式に組み合わせが出てくるためnCkmodを計算するために構造体で最適化している
//改善点として
//使うと決めた文字を末尾にくっつけて最後に並べ替えをする考え方があって
//例としてabbddddeeの並び替えかたは(aaabbなら5C2)(これは組み合わせで考えない)
//各文字を全て区別する場合9文字あるので9!通りあり、
//重複は同じ文字の種類の中だけで起こる。また他の文字種とは完全に独立して起こる
//a関連での重複は1/1!,bでは1/2!,dでは1/4!,eでは1/2!起こる
//よって全体を分子に、各文字での重複(同じ文字の数!)を分母に持ってくる
//ことにより重複を考えた並び替えの総数が求まる
//これを利用すると73行目の遷移式での(j+k)Ckを1/k!に変えて
//一番最後にn!をかけたものが答えとなる
